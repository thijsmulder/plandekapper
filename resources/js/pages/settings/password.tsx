            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        ...
                        description="Zorg ervoor dat je account een sterk, willekeurig wachtwoord gebruikt om veilig te blijven"
                    />
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing}>Wachtwoord opslaan</Button>
